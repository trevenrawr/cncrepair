...
class QuickBooks_Object_Customer extends QuickBooks_Object
{
	...
	{
		return $this->get('TotalBalance', false);
	}
	...
	{
		return $this->set('TaxCodeRef FullName', $name);
	}

	public function setSalesTaxCodeListID($ListID)
	{
		return $this->set('TaxCodeRef ListID', $ListID);
	}

	public function setSalesTaxCodeApplicationID($value)
	{
		return $this->set('TaxCodeRef ' . QUICKBOOKS_API_APPLICATIONID, $this->encodeApplicationID(QUICKBOOKS_OBJECT_SALESTAXCODE, QUICKBOOKS_LISTID, $value));
	}

	public function getSalesTaxCodeApplicationID()
	{
		return $this->get('TaxCodeRef ' . QUICKBOOKS_API_APPLICATIONID);
	}

	public function getSalesTaxCodeName()
	{
		return $this->get('TaxCodeRef FullName');
	}

	public function getSalesTaxCodeListID()
	{
		return $this->get('TaxCodeRef ListID');
	}
	...
	public function setCurrencyName($name) {
		return $this->set('CurrencyRef FullName', $name);
	}
	public function setCurrencyListID($ListID) {
		return $this->set('CurrencyRef ListID', $ListID);
	}

	public function getCurrencyName() {
		return $this->get('CurrencyRef FullName');
	}
